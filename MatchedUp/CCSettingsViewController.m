...
- (void)viewDidLoad
{
    ...
    self.ageSlider.value = [[NSUserDefaults standardUserDefaults] integerForKey:kCCAgeMaxKey];//lecture 329
    ...
    self.ageLabel.text = [NSString stringWithFormat:@"%i", (int)self.ageSlider.value]; //lecture 329
}
...
- (IBAction)logoutButtonPressed:(UIButton *)sender {
    [PFUser logOut];
    [self.navigationController popToRootViewControllerAnimated:YES]; //leccy 333
